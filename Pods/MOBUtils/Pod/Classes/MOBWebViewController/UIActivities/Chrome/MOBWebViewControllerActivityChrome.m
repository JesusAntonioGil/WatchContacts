//
//  MOBWebViewControllerActivityChrome.h
//
...
@implementation MOBWebViewControllerActivityChrome

- (NSString *)activityTitle {
	return NSLocalizedStringFromTable(@"Open in Chrome", @"MOBWebViewController", nil);
}
