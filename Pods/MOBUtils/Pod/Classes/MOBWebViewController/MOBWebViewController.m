...
#import "MOBWebViewControllerActivityChrome.h"
#import "MOBWebViewControllerActivitySafari.h"
#import "MOBWebViewController.h"

@interface MOBWebViewController () <UIWebViewDelegate>
...
@implementation MOBWebViewController
...
- (void)viewWillAppear:(BOOL)animated {
    NSAssert(self.navigationController, @"MOBWebViewController needs to be contained in a UINavigationController. If you are presenting MOBWebViewController modally, use MOBModalWebViewController instead.");
...
- (UIBarButtonItem *)backBarButtonItem {
    if (!_backBarButtonItem) {
        _backBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"MOBWebViewController.bundle/MOBWebViewControllerBack"]
...
- (UIBarButtonItem *)forwardBarButtonItem {
    if (!_forwardBarButtonItem) {
        _forwardBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"MOBWebViewController.bundle/MOBWebViewControllerNext"]
                                                                 style:UIBarButtonItemStylePlain
                                                                target:self
...
- (void)actionButtonTapped:(id)sender {
    ...
    if (url != nil) {
        NSArray *activities = @[[MOBWebViewControllerActivitySafari new], [MOBWebViewControllerActivityChrome new]];
